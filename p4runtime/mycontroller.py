...
SWITCH_TO_HOST_PORT1 = 1
SWITCH_TO_SWITCH_PORT1 = 2
SWITCH_TO_SWITCH_PORT2 = 4
SWITCH_TO_SWITCH_PORT3 = 6
...
def writeTunnelRules(p4info_helper, ingress_sw, egress_sw, tunnel_id,
    ...
    Myport=SWITCH_TO_SWITCH_PORT1
    Myport1=SWITCH_TO_HOST_PORT1
    ...
    if tunnel_id== 100 or tunnel_id== 200 or tunnel_id==  400 :
        Myport=2
    if tunnel_id== 300 or tunnel_id== 500 or tunnel_id== 600  :
        Myport=3
    table_entry = p4info_helper.buildTableEntry(
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        while True:
            ...
            print('--031902518wjm--- s1->s2------------------')
            printCounter(p4info_helper, s1, "MyIngress.ingressTunnelCounter", 100)
            printCounter(p4info_helper, s2, "MyIngress.egressTunnelCounter", 100)
            print('--031902518wjm--- s2->s1------------------')
            printCounter(p4info_helper, s2, "MyIngress.ingressTunnelCounter", 200)
            printCounter(p4info_helper, s1, "MyIngress.egressTunnelCounter", 200)
            # asd
            print('--031902518wjm--- s1->s3------------------')
